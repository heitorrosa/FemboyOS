...
for %a in ("SleepStudy" "Kernel-Processor-Power" "UserModePowerService") do (wevtutil sl Microsoft-Windows-%~a/Diagnostic /e:false) > NUL 2>&1
...
reg add "HKCR\Directory\background\shell\Item2\command" /ve /t REG_SZ /d "C:\Windows\System32\minsudo.exe --Privileged cmd" /f >NUL 2>&1
