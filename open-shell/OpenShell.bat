...
curl -g -k -L -# -o "C:\Windows\Temp\OpenShell.xml" "https://github.com/heitorrosa/FemboyOS/blob/iotltsc/open-shell/OpenShell.xml" >NUL 2>&1 & powershell Start-Process -FilePath "C:\Program Files\Open-Shell\StartMenu.exe -xml C:\Windows\Temp\OpenShell.xml" >NUL 2>&1